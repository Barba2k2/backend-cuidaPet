...
import '../facades/push_notifications_facade.dart' as _i17;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i9.IScheduleService>(
  ...
  gh.lazySingleton<_i17.PushNotificationsFacade>(
      () => _i17.PushNotificationsFacade(log: get<_i8.ILogger>()));
  ...
  gh.lazySingleton<_i27.IChatService>(() => _i28.ChatService(
        ...
        pushNotificationsFacade: get<_i17.PushNotificationsFacade>(),
      ));
